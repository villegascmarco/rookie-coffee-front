...
const CardDetalleP = ({ producto, setDisplay, ingredientes, tokenP, rol }) => {
  ...
  const eliminarIngreProd = (e) => {
    const encontrar = ingredientesP.filter(
      (item) => item.ingrediente !== e.ingrediente
    );
  ...
  const agregarIngrediente = (e) => {
    ...
    if (encontrar == "") {
      ...
      setEmailCE(
        "Ya existe este ingrediente en este producto, si desea aumentar la cantidad elimine el ingrediente de la lista y vuelva agregar"
      );
    }
  };
